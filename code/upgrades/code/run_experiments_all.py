...
if __name__ == '__main__':
    ...
    # Hexaly
    #run('py C:\\Users\\localadmin\\Documents\\GitHub\\scheduling_model_jrc\\code\\upgrades\\code\\test_experiments_workers.py hexaly')
    #run('py C:\\Users\\localadmin\\Documents\\GitHub\\scheduling_model_jrc\\code\\upgrades\\code\\test_experiments.py hexaly')
