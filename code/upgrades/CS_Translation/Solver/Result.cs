...
namespace Solver
{
    ...
    {
        private List<WFJSSPIndividual> _best;
        private WorkerGAConfiguration _parameters;
        ...
        public WorkerResult(List<WFJSSPIndividual> best, WorkerGAConfiguration config, int generations, int functionEvaluations, double timeInSeconds, bool[] triggers, int nRestarts)
        {
            _best = best;
            _parameters = config;
        ...
        public List<WFJSSPIndividual> Best { get => _best; }
        public WorkerGAConfiguration Parameters { get => _parameters; }
