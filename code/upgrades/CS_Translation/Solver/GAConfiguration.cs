...
namespace Solver
{
    ...
    public class WorkerGAConfiguration
    {
        ...
        public WorkerGAConfiguration(WorkerEncoding encoding, WorkerDecisionVariables variables)
        {
            ...
            WFJSSPIndividual.Durations = _durations;
            WFJSSPIndividual.JobSequence = _jobSequence;
            WFJSSPIndividual.AvailableMachines = encoding.GetAllMachinesForAllOperations();
            WFJSSPIndividual.AvailableWorkers = encoding.GetAllWorkersForAllOperations(); // should work now
            WFJSSPIndividual.DetermineMaxDissimiarilty();
    ...
    public class GAConfiguration
    {
        ...
        public GAConfiguration(Encoding encoding, DecisionVariables variables, int populationSize, int offspringAmount, float maxMutationProbability, float maxElitismRate, float maxTournamentRate, float populationGrowthRate, int restartGenerations) : this(encoding, variables)
        {
